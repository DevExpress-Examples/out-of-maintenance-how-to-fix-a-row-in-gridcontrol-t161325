		...
		Public Sub CreateFixedRow(ByVal rowHandle As Integer)
			...
			For i As Integer = 0 To _Grid.Columns.Count - 1
				...
				Else
					...
					AddHandler editor.Loaded, Sub(o, args)
							Dim check = LayoutHelper.FindElement(editor.EditCore, Function(element) element.Name = "checkbox")
							If check IsNot Nothing AndAlso check.Parent IsNot Nothing Then
								CType(check.Parent, FrameworkElement).Margin = New Thickness(0)
							End If
					End Sub
				End If
				...
				Dim brushColor As Color = DirectCast(ColorConverter.ConvertFromString("#FFC3CEDC"), Color)
